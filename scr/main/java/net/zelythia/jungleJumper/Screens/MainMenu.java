...
public class MainMenu extends JPanel implements ActionListener, KeyListener, FocusListener, MouseListener {
    ...
    public void addComponents(){
        ...
        title.setBounds(20, 150, 440, 100);
        title.setBorder(new LineBorder(Color.darkGray, 5));
        title.setFont(font.deriveFont(60f).deriveFont(Font.BOLD));
        title.setForeground(new Color(203,203,203));
        title.setBackground(new Color(64, 106, 71));
