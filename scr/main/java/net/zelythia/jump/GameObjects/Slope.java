...
public class Slope extends GameObject{
    ...
    public static Slope Up(int x, int y, int width, int height){
        ...
        return new Slope(polygon, "scr/main/resources/slope/up.png", - (double) height/ (double) width);
    }
    ...
    public static Slope Down(int x, int y, int width, int height){
        ...
        polygon.translate(x,y);
        return new Slope(polygon, "scr/main/resources/slope/down.png", (double) height/ (double) width);
    }
    ...
    public static Slope UpInv(int x, int y, int width, int height){
        ...
        polygon.translate(x,y);
        return new Slope(polygon, "scr/main/resources/slope/up_inv.png", 0);
    }
    ...
    public static Slope DownInv(int x, int y, int width, int height){
        ...
        polygon.translate(x,y);
        return new Slope(polygon, "scr/main/resources/slope/down_inv.png", 0);
    }
